...
unittests.VisualNovelTest = function(p) {
	...
	this.testsubject = new character.VisualNovel();
}
unittests.VisualNovelTest.__name__ = ["unittests","VisualNovelTest"];
unittests.VisualNovelTest.__super__ = unittests.UnitTest;
